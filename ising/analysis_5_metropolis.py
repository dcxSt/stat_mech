...
df = pd.read_csv("data_N700_MCS400_STEP0005_metropolis_boardsize57x57.csv",header=None)
df.head()
...
# plt.legend()
plt.tight_layout()
# plt.savefig("time_domain_simulation_metropolis_batch4_100.png")
plt.show()
print(len(df)-k)
...
plt.legend()
plt.title("Result, (batch 5 - metropolis)\nN=700 MCS=400",fontsize=22)
plt.xlabel("temperature",fontsize=16)
plt.ylabel("time constant",fontsize=16)
plt.grid()
plt.tight_layout()
# plt.savefig("result_plot_5_large_board_cutoff100.png")
plt.show()
